...
class WekanClient:
    ...
    def __get_api_token(self):
        ...
        json_obj = self.fetch_json(
            "/users/login", http_method="POST", payload=credentials
        )
    ...
    def fetch_json(self, uri_path, http_method="GET", payload=None):
        ...
        try:
            ...
            raise WekanAPIError(
                f"API error: {e.response.text}", status_code=e.response.status_code
            )
    ...
    def add_board(
        ...
        response = self.fetch_json(
            uri_path="/api/boards", http_method="POST", payload=payload
        )
    ...
    def add_user(self, username: str, email: str, password: str) -> WekanUser:
        ...
        response = self.fetch_json(
            uri_path="/api/users", http_method="POST", payload=payload
        )
