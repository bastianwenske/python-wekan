...
class CardChecklistItem(WekanBase):
    ...
    def edit(self, is_finished=None, title=None) -> None:
        ...
        according to https://wekan.github.io/api/v6.26/#edit_checklist_item
    ...
    def delete(self) -> None:
        """
        Delete the Card Checklist instance according to https://wekan.github.io/api/v6.26/#delete_checklist_item
        :return: None
        """
